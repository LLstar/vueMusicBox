...
<style>
  ...
  .singerZH>.hot-singer>.mui-table-view {
    background: rgba(255,255,255,0);
    border: none;
  }
  .singerZH>.hot-singer>.mui-table-view>.mui-table-view-cell .mui-media-object {
    max-width: 65px;
    height: 65px;
    line-height: 65px;
    border-radius: 50%;
  }
  .singerZH>.hot-singer>.mui-table-view>.mui-table-view-cell .mui-media-body {
    margin-top: 10px;
  }
  .singerZH>.hot-singer>.singer-title {
    margin: 0;
    margin-left: 15px;
    color: gold;
    font-weight: bold;
  }
  .singerZH>.hot-singer .mui-media-body>div.mui-pull-left>p:first-child {
    color: #fff;
    width: 95px;
    white-space: nowrap;
    overflow: hidden;
  }
  .singerZH>.hot-singer .mui-media-body>div.mui-pull-left>p.mui-ellipsis {
    color: #ccc;
  }
  .singerZH>.hot-singer>.mui-table-view:before,
  .singerZH>.hot-singer>.mui-table-view:after,
  .singerZH>.hot-singer>.mui-table-view .mui-table-view-cell:after {
    height:0;
  }
  .singerZH>.hot-singer .mui-media-body>span.mui-pull-right.is-heart{
    float: right;
    display: block;
    width: 78px;
    height: 30px;
  ...
  .singerZH>.hot-singer .mui-media-body>span.mui-pull-right.no-heart{
    float: right;
    display: block;
    width: 78px;
    height: 30px;
  ...
  .singerZH>.hot-singer .mui-media-body>span.mui-pull-right.hidden {
    display: none;
  }
</style>