...
<script>
  ...
  export default {
    ...
    methods:{
      getSinger(){
        this.$http.get("singer/singerUSA")
        .then(res=>{
          if(res.body.code == 1){
...
<style>
  ...
  .singerUSA>.hot-singer {
      margin-top: 20px;
      padding: 10px 0;
  }
  .singerUSA>.hot-singer>.mui-table-view {
    background: rgba(255,255,255,0);
    border: none;
  }
  .singerUSA>.hot-singer>.mui-table-view>.mui-table-view-cell .mui-media-object {
    max-width: 65px;
    height: 65px;
    line-height: 65px;
    border-radius: 50%;
  }
  .singerUSA>.hot-singer>.mui-table-view>.mui-table-view-cell .mui-media-body {
    margin-top: 10px;
  }
  .singerUSA>.hot-singer>.singer-title {
    margin: 0;
    margin-left: 15px;
    color: gold;
    font-weight: bold;
  }
  .singerUSA>.hot-singer .mui-media-body>div.mui-pull-left>p:first-child {
    color: #fff;
    width: 95px;
    white-space: nowrap;
    overflow: hidden;
  }
  .singerUSA>.hot-singer .mui-media-body>div.mui-pull-left>p.mui-ellipsis {
    color: #ccc;
  }
  .singerUSA>.hot-singer>.mui-table-view:before,
  .singerUSA>.hot-singer>.mui-table-view:after,
  .singerUSA>.hot-singer>.mui-table-view .mui-table-view-cell:after {
    height:0;
  }
  .singerUSA>.hot-singer .mui-media-body>span.mui-pull-right.is-heart{
    float: right;
    display: block;
    width: 78px;
    height: 30px;
  ...
  .singerUSA>.hot-singer .mui-media-body>span.mui-pull-right.no-heart{
    float: right;
    display: block;
    width: 78px;
    height: 30px;
  ...
  .singerUSA>.hot-singer .mui-media-body>span.mui-pull-right.hidden {
    display: none;
  }
</style>