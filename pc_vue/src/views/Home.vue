<template>
  <div class="home">
    ...
    <!--第二部分图片轮播图-->
    <mt-swipe :auto="4000">
      <mt-swipe-item v-for="item in imglist" :key="item.cid"><img :src="item.pic_url"></mt-swipe-item>
    </mt-swipe>
    <!--第三部分六宫格-->
    <ul class="mui-table-view mui-grid-view mui-grid-9">
      <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-3"><router-link to="/singer">
      ...
      <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-3"><router-link to="/goodslist">
              <span class="iconfont icon-fenlei"></span>
              <div class="mui-media-body">分类</div></router-link></li>
      <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-3"><router-link to="/words">
              <span class="iconfont icon-gedan"></span>
              <div class="mui-media-body">歌单</div></router-link></li>
      ...
      <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-3"><router-link to="/concat">
    ...
    <div>
      <ul class="songmenu">
        <li class="songmenu-item" v-for="menu in menus" :key="menu.sid">
          ...
          <p class="song-info">
            <span>播放量：{{menu.playcount}}万</span>
...
<style>
  ...
  .home .mui-table-view.mui-grid-view .mui-table-view-cell span.icon-gedan {
    background: #EE9A49;
  }
